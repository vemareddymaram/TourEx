...
import '/components/add_tour_pg_widget.dart';
import '/components/nearby_htls_rtng_bar_widget.dart';
import '/components/review_bar_widget.dart';
import '/components/similar_plc_rtng_bar_widget.dart';
...
import 'place_description_model.dart';
export 'place_description_model.dart';

class PlaceDescriptionWidget extends StatefulWidget {
  const PlaceDescriptionWidget({
    super.key,
    required this.placeImage,
    required this.placeName,
    required this.placeRatings,
    required this.placeIsFav,
  ...
  final double? placeRatings;
  final bool? placeIsFav;
  final String? placeDes;
  final String? placeAdd;
  final LatLng? placeLoc;

  @override
  _PlaceDescriptionWidgetState createState() => _PlaceDescriptionWidgetState();
}

class _PlaceDescriptionWidgetState extends State<PlaceDescriptionWidget>
    with TickerProviderStateMixin {
  late PlaceDescriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaceDescriptionModel());
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FutureBuilder<ApiCallResponse>(
                                  future:
                                      WeatherGroup.realtimeWeatherAPICall.call(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Builder(builder: (context) {
                                      final googleMapMarker = widget.placeLoc;
                                              ...
                                              builder: (context) {
                                                ...
                                                return ListView.separated(
                                                  ...
                                                  scrollDirection:
                                                      Axis.horizontal,
                                                  itemCount:
                                                      similarPlcsItems.length,
                                                  separatorBuilder: (_, __) =>
                                                      const SizedBox(width: 20.0),
                                                  itemBuilder: (context,
                                                      similarPlcsItemsIndex) {
                                                    final similarPlcsItemsItem =
                                                        similarPlcsItems[
                                                            similarPlcsItemsIndex];
                                                    return Align(
                                                      alignment:
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                        child:
                                                                            SimilarPlcRtngBarWidget(
                                                                          key: Key(
                                                                              'Keymzv_${similarPlcsItemsIndex}_of_${similarPlcsItems.length}'),
                                                                          parameter1:
                                                                              similarPlcsItemsItem.rating,
                                                                        ),
                                                                      ),
                                                                    ),
                                                                  ],
                                          ...
                                          child: Container(
                                            ...
                                            child:
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                final listViewHotelsGetDetailsAPIDeprecatedResponse =
                                                    snapshot.data!;
                                                return Builder(
                                                  builder: (context) {
                                                    final nearbyHotels =
                                                        listViewHotelsGetDetailsAPIDeprecatedResponse
                                                            .jsonBody
                                                            .toList()
                                                            .take(5)
                                                            .toList();
                                                                        ...
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            padding: const EdgeInsetsDirectional.fromSTEB(
                                                                                ...
                                                                                0.0),
                                                                            child:
                                                                                NearbyHtlsRtngBarWidget(
                                                                              key: Key('Key7yl_${nearbyHotelsIndex}_of_${nearbyHotels.length}'),
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration:
                                                          ...
                                                          image:
                                                            ...
                                                            image:
                                                                CachedNetworkImageProvider(
                                                              'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxyZXN0YXVyYW50fGVufDB8fHx8MTY5NjU5OTc3M3ww&ixlib=rb-4.0.3&q=80&w=1080',
                                                            ),
                                                          ),
                                                          boxShadow: const [
                                                            BoxShadow(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            setState(() =>
                                                                                FFAppState().dislike = !FFAppState().dislike);
                                                                          },
                                                                          value:
                                                                              FFAppState().dislike,
                                                                          onIcon:
