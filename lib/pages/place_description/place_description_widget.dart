...
class PlaceDescriptionWidget extends StatefulWidget {
  const PlaceDescriptionWidget({Key? key}) : super(key: key);
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                    ...
                                                    image:
                                                      ...
                                                      'https://th.bing.com/th/id/OIP.a9sYdMiQTfD-Y1CTl9_CCQHaHa?w=203&h=203&c=7&r=0&o=5&dpr=2&pid=1.7',
                                                    ),
                                                  ),
                                                  borderRadius:
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                ...
                                                image:
                                                    CachedNetworkImageProvider(
                                                  'https://1000logos.net/wp-content/uploads/2021/07/Latex-Degree-Symbol-2048x1152.png',
                                                ),
                                              ),
                                              borderRadius:
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        image: DecorationImage(
                                                          ...
                                                          image:
                                                              CachedNetworkImageProvider(
                                                            'https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxNnx8aG90ZWxzfGVufDB8fHx8MTY5NjY3ODA1MXww&ixlib=rb-4.0.3&q=80&w=1080',
                                                          ),
                                                        ),
                                                        boxShadow: [
                                                          BoxShadow(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 20.0, 0.0, 0.0),
                                      child: StreamBuilder<
                                          List<RatingsNReviewsRecord>>(
                                        stream: queryRatingsNReviewsRecord(),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                          ...
                                          List<RatingsNReviewsRecord>
                                              listViewRatingsNReviewsRecordList =
                                              snapshot.data!;
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              final listViewRatingsNReviewsRecord =
                                                  listViewRatingsNReviewsRecordList[
                                                      listViewIndex];
                                              return Container(
                                                width:
